...
This file maps the Customer Experience Data Analyst requirements to concrete project evidence.
...
| Excel / BI evidence | `dashboard-workbook/customer_experience_dashboard.xlsx` | Dashboard, raw data, pivot summary, at-risk segments, recommendations |
...
```text
customer-analytics, data-analysis, dashboard, excel, cx, portfolio-project, customer-experience, segmentation
```
