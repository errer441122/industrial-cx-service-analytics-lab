(function () {
  ...
  "project": {
    "title": "Ducati CX Analytics Workbook",
    ...
    "disclaimer": "Questo e un caso studio portfolio indipendente basato su dati Customer Experience simulati. Non e collegato a sistemi Ducati, non usa dati cliente riservati ed e pensato per dimostrare ragionamento analitico, logica dashboard e gestione responsabile dei dati.",
  ...
  "caseStudy": {
    ...
    "solution": "Ho progettato un workbook simulato di analisi Customer Experience che combina data intake, scoring dei segmenti, tracking degli stage del journey, diagnosi dei trend, dashboard reporting, guardrail privacy-aware e logica di handoff verso azione.",
    ...
    "limitations": "Il progetto usa dati simulati, non ha integrazione CRM live ed e pensato come prototipo portfolio, non come sistema analytics di produzione.",
    "nextIteration": "In un contesto operativo reale, la prossima iterazione aggiungerebbe integrazione CRM o survey, reporting in stile Power BI, viste per ruolo, refresh automatici, controlli di qualita dati, controlli privacy cliente e misurazione del feedback loop dopo le azioni.",
    "outputs": [
  ...
  "adoptionGovernance": {
    ...
    "successMetrics": [
      "Utenti attivi settimanali o mensili che rivedono il workbook CX.",
    ...
    "workflows": [
      {
        ...
        "conditions": [
          "Score ponderato >= 4.0",
          "Trend soddisfazione negativo",
          "Campione sopra soglia minima"
        ],
      ...
      },
      {
        ...
        "conditions": [
          "Esiste feedback legato al dealer",
          "Action item aperti > 0",
      ...
      },
      {
        ...
        "conditions": [
          ...
          "Metodo di aggregazione poco chiaro",
          "Responsabile dell'accesso non nominato"
        ],
      ...
      },
      {
        ...
        "conditions": [
          ...
          "Metrica di follow-up mancante o non aggiornata"
        ],
      ...
      },
      {
        ...
        "conditions": [
          "Guida di reporting approvata disponibile",
          "Percorso di escalation al responsabile CX definito"
        ],
  ...
  "productBrief": {
    ...
    "businessMetrics": [
      ...
      },
      {
        ...
        "businessImpact": "Identificazione anticipata di frizioni ricorrenti nel journey"
      },
      {
  ...
  "pipelineStages": [
    ...
    {
      "name": "Analisi Segmento",
      "probability": 0.35
    },
    {
      "name": "Reporting Soddisfazione",
      "probability": 0.5
    },
    {
      "name": "Diagnosi Journey",
      "probability": 0.65
    },
    {
      "name": "Backlog Miglioramenti",
      "probability": 0.75
    },
    {
      "name": "Action Pilot",
  ...
  "accounts": [
    {
      ...
      "scoreComponents": {
        ...
        "regulatoryUrgency": 5,
        "dataComplexity": 4,
        "stakeholderClarity": 5,
        "deploymentFit": 5,
        "procurementFeasibility": 4
      }
    },
    {
      "id": 2,
  ...
  "pipelineDeals": [
    {
      "id": "CX1",
      "accountId": 1,
      "stage": "Reporting Soddisfazione",
      "value": 42000,
      "daysInStage": 8,
      "pocReadiness": 74,
      "risk": "Campione",
      "nextStep": "Validare copertura survey primi 30 giorni e aggiungere note consegna dealer."
    },
    {
      "id": "CX2",
      "accountId": 2,
      ...
      "daysInStage": 12,
      "pocReadiness": 68,
      "risk": "Collegamento dati",
      "nextStep": "Collegare feedback service con note del segmento touring-use."
    },
    {
      "id": "CX3",
      "accountId": 3,
      "stage": "Analisi Segmento",
      "value": 18000,
      "daysInStage": 6,
      "pocReadiness": 54,
      "risk": "Gap aspettative",
      "nextStep": "Separare feedback di consegna da richieste di product support."
    },
    {
      "id": "CX4",
      "accountId": 4,
      "stage": "Backlog Miglioramenti",
      "value": 28000,
      "daysInStage": 5,
      "pocReadiness": 71,
    ...
    },
    {
      ...
      "daysInStage": 16,
      "pocReadiness": 82,
      "risk": "Processo dealer",
      "nextStep": "Testare reminder appuntamento e template di spiegazione post-service."
    },
    {
      "id": "CX6",
      "accountId": 6,
      ...
      "daysInStage": 18,
      "pocReadiness": 63,
      "risk": "Timing risoluzione",
      "nextStep": "Mappare campi stato claim e gap comunicativi ricorrenti."
    },
    {
      "id": "CX7",
      "accountId": 7,
      ...
      "pocReadiness": 46,
      "risk": "Attribuzione",
      "nextStep": "Definire percorso evento da configuratore a follow-up lead."
    },
    {
      "id": "CX8",
      "accountId": 8,
      "stage": "Azione Completata",
      "value": 17000,
      "daysInStage": 2,
      "pocReadiness": 91,
      "risk": "Nessuno",
      "nextStep": "Confrontare soddisfazione del follow-up post-evento dopo il pilot."
    },
    {
      "id": "CX9",
      "accountId": 9,
    ...
    },
    {
      ...
      "daysInStage": 7,
      "pocReadiness": 77,
      "risk": "Allineamento responsabile",
      "nextStep": "Assegnare responsabile follow-up dealer e metrica target sul tempo di risposta."
    },
    {
      "id": "CX11",
      "accountId": 11,
      "stage": "Fonte Dati Identificata",
      "value": 14000,
      "daysInStage": 4,
      "pocReadiness": 31,
      "risk": "Basso priority",
      "nextStep": "Confermare quale touchpoint retail ha campione sufficiente."
    },
    {
      "id": "CX12",
      "accountId": 12,
      ...
      "daysInStage": 14,
      "pocReadiness": 61,
      "risk": "Logica retention",
      "nextStep": "Controllare completezza service history prima delle conclusioni di segmento."
    },
    {
      "id": "CX13",
      "accountId": 13,
      ...
      "daysInStage": 11,
      "pocReadiness": 57,
      "risk": "Chiarezza follow-up",
      "nextStep": "Mappare domande su finanziamento e trade-in per tempo risposta dealer."
    },
    {
      "id": "CX14",
      "accountId": 14,
      ...
      "daysInStage": 6,
      "pocReadiness": 73,
      "risk": "Campione piccolo",
      "nextStep": "Usare note qualitative insieme ai segnali quantitativi di trend."
    },
    {
      "id": "CX15",
      "accountId": 15,
      ...
      "pocReadiness": 42,
      "risk": "Campi lingua",
      "nextStep": "Taggare campi lingua e tipo visita prima dell'analisi."
    },
    {
      "id": "CX16",
      "accountId": 16,
  ...
  "handoffChecklist": [
    {
      "title": "Segmento cliente definito chiaramente",
      "desc": "Segmento, stage del journey e dati fonte sono documentati."
    },
    {
      "title": "Segnale di soddisfazione validato",
      "desc": "Campione, dati mancanti e direzione del trend sono controllati prima di condividere conclusioni."
    },
    {
    ...
    },
    {
      ...
      "desc": "Viene assegnato un responsabile CX, CRM, service, dealer, product o digital."
    },
    {
      "title": "Metrica azione selezionata",
      "desc": "Il miglioramento ha una metrica di follow-up misurabile, non solo un obiettivo qualitativo."
    },
    {
    ...
    },
    {
      ...
      "desc": "La prossima data di revisione e la fonte evidenza sono documentate."
    },
    {
      "title": "Apprendimento registrato",
      "desc": "I risultati rientrano nel modello segmenti o nel backlog reporting."
    }
  ],
  "complianceChecklist": [
